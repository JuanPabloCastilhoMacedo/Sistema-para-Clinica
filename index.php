	      ...
	      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
	        ...
	        <li class="nav-item dropdown">
	         ...
	         <li class="nav-item dropdown">
	          ...
	          <ul class="dropdown-menu">
	            <li><a class="dropdown-item" href="?page=cadastrar-prescricoes">Cadastrar</a></li>
	            <li><a class="dropdown-item" href="?page=listar-prescricoes">Listar</a></li>	            
	          </ul>
	        </li>
			...
			<div class="col">
				<?php
					...
					switch (@$_REQUEST['page']) {
						...
						case 'cadastrar-prescricoes':
							include('cadastrar-prescricoes.php');
							break;
						case 'editar-prescricoes':
							include('editar-prescricoes.php');
							break;
						case 'listar-prescricoes':
							include('listar-prescricoes.php');
							break;
						case 'salvar-prescricoes':
							include('salvar-prescricoes.php');
							break;
